...
public class Form_Peminjam extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        panelGlass2.setBackground(new java.awt.Color(204, 204, 204));
        panelGlass2.setWarna(new java.awt.Color(51, 51, 51));
        panelGlass2.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel5.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("Alamat   ");
        panelGlass2.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 210, 100, -1));

        jLabel4.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("NIK        ");
        panelGlass2.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 150, 100, -1));
        panelGlass2.add(txt_nik_peminjam, new org.netbeans.lib.awtextra.AbsoluteConstraints(497, 140, 370, 36));

        jLabel22.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jLabel22.setForeground(new java.awt.Color(255, 255, 255));
        jLabel22.setText("No. Tlp  ");
        panelGlass2.add(jLabel22, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 270, 100, -1));

        jLabel24.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jLabel24.setForeground(new java.awt.Color(255, 255, 255));
        jLabel24.setText("Email     ");
        panelGlass2.add(jLabel24, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 330, 100, 20));
        panelGlass2.add(txt_email_peminjam, new org.netbeans.lib.awtextra.AbsoluteConstraints(495, 320, 370, 36));
        ...
        panelGlass2.add(txt_tlp_peminjam, new org.netbeans.lib.awtextra.AbsoluteConstraints(497, 260, 370, 37));

        txt_alamat.setColumns(20);
        txt_alamat.setRows(5);
        jScrollPane1.setViewportView(txt_alamat);

        panelGlass2.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(497, 190, 370, 50));

        btn_next.setForeground(new java.awt.Color(255, 255, 255));
        btn_next.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/arrow_right.png"))); // NOI18N
        btn_next.setText("Next");
        btn_next.setFont(new java.awt.Font("Arial Black", 1, 12)); // NOI18N
        btn_next.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_nextActionPerformed(evt);
            }
        });
        panelGlass2.add(btn_next, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 420, -1, -1));

        btn_erase.setForeground(new java.awt.Color(255, 255, 255));
        btn_erase.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/trash_box.png"))); // NOI18N
        btn_erase.setText("Clear");
        btn_erase.setFont(new java.awt.Font("Arial Black", 1, 12)); // NOI18N
        btn_erase.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_eraseActionPerformed(evt);
            }
        });
        panelGlass2.add(btn_erase, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 420, 110, -1));

        jLabel8.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setText("Nama    ");
        panelGlass2.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 100, 100, -1));
        ...
        panelGlass2.add(txt_nama_peminjam, new org.netbeans.lib.awtextra.AbsoluteConstraints(497, 90, 370, 36));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/pinjaman.png"))); // NOI18N
        panelGlass2.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 10, 170, 190));

        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/mobil.png"))); // NOI18N
        panelGlass2.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 180, -1, -1));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/motor.png"))); // NOI18N
        panelGlass2.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 120, -1, -1));
        ...
        jLabel6.setText("Peminjaman Kendaraan");
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 30, -1, -1));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/bgp.jpg"))); // NOI18N
