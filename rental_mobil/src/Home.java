...
public class Home extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btn_formUser.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/user_1.png"))); // NOI18N
        btn_formUser.setText("Tambah User");
        btn_formUser.setFont(new java.awt.Font("Arial Black", 1, 12)); // NOI18N
        ...
        getContentPane().add(btn_formUser, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 410, 250, 80));

        btn_transaksi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/pengembalian.png"))); // NOI18N
        btn_transaksi.setText("Pengembalian ");
        btn_transaksi.setFont(new java.awt.Font("Arial Black", 1, 12)); // NOI18N
        ...
        getContentPane().add(btn_transaksi, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 320, 250, 80));

        btn_formPeminjam.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/pinjam_1.png"))); // NOI18N
        btn_formPeminjam.setText("Peminjaman");
        btn_formPeminjam.setFont(new java.awt.Font("Arial Black", 1, 12)); // NOI18N
        ...
        getContentPane().add(btn_formPeminjam, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 230, 250, 80));

        jDesktopPane1.setBackground(new java.awt.Color(255, 105, 180));
        getContentPane().add(jDesktopPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 0, 1220, 850));

        btn_formMobil.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/tambah.png"))); // NOI18N
        btn_formMobil.setText("Tambah Kendaraan");
        btn_formMobil.setFont(new java.awt.Font("Arial Black", 1, 12)); // NOI18N
        ...
        getContentPane().add(btn_formMobil, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 140, 250, 80));

        btn_login.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/logcek.png"))); // NOI18N
        ...
        getContentPane().add(btn_login, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 50, 250, 80));
        ...
        btn_log_Off.setFont(new java.awt.Font("Arial Black", 1, 14)); // NOI18N
        ...
        getContentPane().add(btn_log_Off, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 50, 250, 80));

        btn_closee.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/exit.png"))); // NOI18N
        btn_closee.setText("Exit");
        btn_closee.setFont(new java.awt.Font("Arial Black", 1, 12)); // NOI18N
        ...
        getContentPane().add(btn_closee, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 640, 210, 80));

        btn_closee1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/about_1.png"))); // NOI18N
        btn_closee1.setText("About");
        btn_closee1.setFont(new java.awt.Font("Arial Black", 1, 12)); // NOI18N
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -30, 300, -1));
